...
export function LampDemo() {
  return (
    ...
    <LampContainer>
      ...
      >
      <span className="text-[#4edcf5] text-[60px]">Polarsystem</span><br />seguridad para tu auto      
      </motion.h1>
    </LampContainer>
    </>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full h-[890px] flex flex-col items-center justify-center overflow-hidden bg-slate-950",
        className
      )}
    >
