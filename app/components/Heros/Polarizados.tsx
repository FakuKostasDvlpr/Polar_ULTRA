    ...
    <>
      <section id="polarizados" className="gap-4 flex-col m-auto text-white items-center justify-center flex bg-[#020617]">
        ...
        <div className="flex flex-col flex-wrap md:flex-row items-start justify-around gap-20">
          <Materiales />
          <div className="flex flex-col mx-auto gap-10 sm:mt-40 bg-gray-400 bg-opacity-30 w-[380px] h-[270px] items-start rounded-xl px-10 justify-center">
            <p className="text-white">Para cotizaciones de obras y colores, dejanos tu mensaje!</p>
          <div>
